...
struct ImGuiViewportDataWin32
{
    ...
    DWORD   DwExStyle;
    HDC     dc;
    ImGuiViewportDataWin32() { Hwnd = NULL; HwndOwned = false;  DwStyle = DwExStyle = 0; dc = 0; }
...
static void ImGui_ImplWin32_CreateWindow(ImGuiViewport* viewport)
{
    ...
    int pixelFormat = ChoosePixelFormat(GetDC(data->Hwnd), &pfd);
    SetPixelFormat(GetDC(data->Hwnd), pixelFormat, &pfd);
    ...
    data->dc = GetDC(data->Hwnd);
    wglCreateContextAttribsARB(data->dc, wglGetCurrentContext(), attribs);
}
...
static void ImGuiImplWin32_SwapBuffers(ImGuiViewport* viewport, void* renderer_render_arg)
{
    ImGuiViewportDataWin32* data = (ImGuiViewportDataWin32*)viewport->PlatformUserData;
    SwapBuffers(data->dc);
}

static void ImGuiImplWin32_RenderWindow(ImGuiViewport* viewport, void* renderer_render_arg)
{
    ImGuiViewportDataWin32* data = (ImGuiViewportDataWin32*)viewport->PlatformUserData;
    wglMakeCurrent(data->dc, wglGetCurrentContext());
}
...
static void ImGui_ImplWin32_InitPlatformInterface()
{
    ...
    platform_io.Platform_RenderWindow = ImGuiImplWin32_RenderWindow;
    platform_io.Platform_SwapBuffers = ImGuiImplWin32_SwapBuffers;
#if HAS_WIN32_IME
